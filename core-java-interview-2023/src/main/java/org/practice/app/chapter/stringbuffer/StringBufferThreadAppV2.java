...
public class StringBufferThreadAppV2 {
    public static void main(String[] args) {
        ...
        Thread thread1 = new Thread(new StringBufferManipulatorV2(commonStringBuffer,"Thread-1"));
        Thread thread2 = new Thread(new StringBufferManipulatorV2(commonStringBuffer,"Thread-2"));
